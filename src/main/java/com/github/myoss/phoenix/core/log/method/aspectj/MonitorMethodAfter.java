...
public class MonitorMethodAfter extends AbstractMonitorMethod {
     ...
     * </ul>
     */
    @Pointcut("@within(com.github.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodAfter)"
            // 放在class上有效，method上无效
            + " || @annotation(com.github.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodAfter)"
    // 放在class上无效，method上有效
    )
