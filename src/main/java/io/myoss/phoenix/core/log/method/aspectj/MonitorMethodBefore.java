...
import io.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodBefore;
...
public class MonitorMethodBefore extends AbstractMonitorMethod {
     ...
     * <code>@io.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodBefore</code>
     * </ul>
     */
    @Pointcut("@within(io.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodBefore)"// 放在class上有效，method上无效
            + " || @annotation(io.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodBefore)" // 放在class上无效，method上有效
    )
