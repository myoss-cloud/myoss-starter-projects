...
/**
 * 注解 {@link LogMethodAround} 放在类和方法上
 *
 * @author Jerry.Chen
...
public class MonitorMethodAroundCase3Tests {
    ...
    public void logOnClassAndMethodMatchTest1() {
        ...
        assertThat(beforeLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase3Tests$LogOnClassAndMethodTest#isMatch1]",
    ...
    public void logOnClassAndMethodMatchTest2() {
        ...
        String afterLine = lines[1];
        assertThat(beforeLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase3Tests$LogOnClassAndMethodTest#isMatch2]",
                "[MonitorMethodAround.java");
        assertThat(afterLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase3Tests$LogOnClassAndMethodTest#isMatch2]",
                "[MonitorMethodAround.java");
    ...
    public void logOnClassAndMethodMatchTest3() {
        ...
        String afterLine = lines[1];
        assertThat(beforeLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase3Tests$LogOnClassAndMethodTest#isMatch3]",
                "[MonitorMethodAround.java");
        assertThat(afterLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase3Tests$LogOnClassAndMethodTest#isMatch3]",
                "[MonitorMethodAround.java");
