...
import com.github.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodAfter;
...
public class MonitorMethodAfter extends AbstractMonitorMethod {
     ...
     * <code>@com.github.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodAfter</code>
     * </ul>
     */
    @Pointcut("@within(com.github.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodAfter)"// 放在class上有效，method上无效
            + " || @annotation(com.github.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodAfter)" // 放在class上无效，method上有效
    )
