...
public class MonitorMethodAroundCase1Tests {
    ...
    public void logOnMethodMatchTest1() {
        ...
        assertThat(beforeLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase1Tests$LogOnMethodTest#isMatch]",
    ...
    public void logOnMethodMatchTest2() {
        ...
        String afterLine = lines[1];
        assertThat(beforeLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase1Tests$LogOnMethodTest#isMatch2]",
                "[MonitorMethodAround.java");
        assertThat(afterLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase1Tests$LogOnMethodTest#isMatch2]",
                "[MonitorMethodAround.java");
