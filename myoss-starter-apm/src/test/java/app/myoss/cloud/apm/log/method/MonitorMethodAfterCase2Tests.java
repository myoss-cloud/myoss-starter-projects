...
public class MonitorMethodAfterCase2Tests {
    ...
    public void logOnClassMatchTest1() {
        ...
        assertThat(printLog).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAfterCase2Tests$LogOnClassTest#isMatch1]",
    ...
    public void logOnClassMatchTest2() {
        ...
        String printLog = this.output.toString();
        assertThat(printLog).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAfterCase2Tests$LogOnClassTest#isMatch2]",
                "[MonitorMethodAfter.java");
    ...
    public void logOnClassMatchTest3() {
        ...
        String printLog = this.output.toString();
        assertThat(printLog).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAfterCase2Tests$LogOnClassTest#isMatch3]",
                "[MonitorMethodAfter.java");
