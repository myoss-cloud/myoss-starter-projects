 ...
 * 放在类上，只有 {@link LogMethodAround} 生效
 *
 * @author Jerry.Chen
...
public class MonitorMethodAroundCase5Tests {
    ...
    public void logOnClassMatchTest1() {
        ...
        assertThat(beforeLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase5Tests$LogOnClassTest#isMatch1]",
    ...
    public void logOnClassMatchTest2() {
        ...
        String afterLine = lines[1];
        assertThat(beforeLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase5Tests$LogOnClassTest#isMatch2]",
                "[MonitorMethodAround.java");
        assertThat(afterLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase5Tests$LogOnClassTest#isMatch2]",
                "[MonitorMethodAround.java");
    ...
    public void logOnClassMatchTest3() {
        ...
        String afterLine = lines[1];
        assertThat(beforeLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase5Tests$LogOnClassTest#isMatch3]",
                "[MonitorMethodAround.java");
        assertThat(afterLine).contains(
                "[app.myoss.cloud.apm.log.method.MonitorMethodAroundCase5Tests$LogOnClassTest#isMatch3]",
                "[MonitorMethodAround.java");
