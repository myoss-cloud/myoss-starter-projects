...
import io.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodAround;
 ...
 *
 * @author Jerry.Chen 2018年4月11日 下午12:15:16
 * @see LogMethodAround
 */
...
public class MonitorMethodAround extends AbstractMonitorMethod {
     ...
     * </ul>
     */
    @Pointcut("@within(io.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodAround)"// 放在class上有效，method上无效
            + " || @annotation(io.myoss.phoenix.core.log.method.aspectj.annotation.LogMethodAround)" // 放在class上无效，method上有效
    )
