...
/**
 * 注解 {@link LogMethodBefore}、 {@link LogUnMonitor} 放在类和方法上，不输出log，只有
...
public class UnMonitorMethodBeforeCase3Tests {
    @Rule
    ...
    /**
     * 注解 {@link LogMethodBefore}、{@link LogUnMonitor} 放在类和方法上
     */
    @LogUnMonitor
    @LogMethodBefore
